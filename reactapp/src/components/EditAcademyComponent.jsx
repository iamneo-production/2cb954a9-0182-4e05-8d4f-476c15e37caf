...
class EditAcademyComponent extends Component {
    constructor(props){
        super(props)
        ...
        this.editAcademy = this.editAcademy.bind(this);
    }
    ...
    componentDidMount() {
        ...
        AcademyService.getAcademy(academyId).then((res) => {
            this.setState({ 
                instituteName: res.data.instituteName,
                instituteDescription: res.data.instituteDescription,
                instituteAddress: res.data.instituteAddress,
    ...
    editAcademy = (e) => {
        ...
        AcademyService.updateAcademy(ACADEMY_ID, academy);
              ...
              <br></br>
                ...
                <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                  ...
                  <div className="-mx-3 md:flex mt-2">
                    <div className="md:w-full px-3">
                      <button onClick={this.editAcademy} className="md:w-full bg-gray-900 text-white font-bold py-2 px-4 border-b-4 hover:border-b-2 border-gray-500 hover:border-gray-100 rounded-full">
                        Update Accademy
                      </button>
                    </div>
                  </div>
...
export default EditAcademyComponent;
